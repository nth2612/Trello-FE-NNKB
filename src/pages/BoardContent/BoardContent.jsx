...
const BoardContent = ({ board, moveColumn, createNewColumn, createNewCard, moveCardToDiffColumn, moveCardInSameCol, deleteOneColumn, renameColumn, deleteCard, renameCard }) => {
